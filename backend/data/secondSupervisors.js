/**
 * Second Supervisors Data
 * Mapping: Project -> Second Supervisors
 */
...
const secondSupervisors = {
  ...
  "STAR IDP": { 
    ...
    "Cirirbandar": [{ name: "Easir Arafat/RM" }],
    "Fulbari": [{ name: "Easir Arafat/RM" }],
    "Birampur": [{ name: "Easir Arafat/RM" }],
    "Nawabganj": [{ name: "Easir Arafat/RM" }],
    "Ghoraghat": [{ name: "Easir Arafat/RM" }],
    "Hakimpur": [{ name: "Easir Arafat/RM" }],
    "Tanore": [{ name: "Juwel Hossain/RM" }],
    "Niamothpur": [{ name: "Juwel Hossain/RM" }],
